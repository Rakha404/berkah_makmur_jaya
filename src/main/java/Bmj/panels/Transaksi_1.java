...
public class Transaksi_1 extends javax.swing.JPanel {
    ...
    public Transaksi_1() {
        ...
        String[] judul = {"ID", "Merk", "Tipe", "Harga", "Jumlah", "Subtotal"};
        model = new javax.swing.table.DefaultTableModel(judul, 0);
    ...
    public void tampilkanBarang(){
        try {
            ...
            java.sql.ResultSet res = stm.executeQuery("SELECT id_motor FROM tabel_motor");
    ...
    private void simpanTransaksi() {
        ...
        try {
            ...
            for (int i = 0; i < baris; i++) {
                ...
                // Masukkan ke detail
                String sqlDetail = "INSERT INTO detail_transaksi (id_transaksi, id_motor, jumlah, subtotal) VALUES (?, ?, ?, ?)";
                ...
                // Potong Stok
                String sqlStok = "UPDATE motor SET stok = stok - ? WHERE id_motor = ?";
    ...
    private void pilihMotor() {
        ...
        try {
            ...
            if(res.next()){
                ...
                stokSisa = res.getInt("stok");
                System.out.println("Stok terambil" + stokSisa);  
