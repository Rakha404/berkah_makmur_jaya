...
public class DashboardKasirr1 extends javax.swing.JFrame {
    Pegawai P;
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DashboardKasirr1.class.getName());

 
    public DashboardKasirr1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DashboardKasirr1().setVisible(true));
    }
